...
| [``aula-2.php``](https://github.com/AdrianoBispo/formacao-php/blob/master/arrays-e-strings/php-strings/aula-2.php)  | ``str_starts_with()`` e ``str_ends_with()``     | _**São utilizadas para verificar se uma string começa ou termina com determinado conjunto de caracteres e retorna um valor booleano.**_ |
| [``aula-3.php``](https://github.com/AdrianoBispo/formacao-php/blob/master/arrays-e-strings/php-strings/aula-3.php) | ``substr()``                                    | _É uma função que **permite extrair um trecho de caracteres específico.** Ela pode ser usada para uma variedade de tarefas, incluindo: Extrair um trecho específico de uma string, como uma palavra ou uma frase. Extrair uma substring de uma string com base em sua posição inicial e comprimento. Remover um trecho de uma string, definindo o comprimento como 0. Validar se uma string contém um padrão específico em uma posição específica._                       |
